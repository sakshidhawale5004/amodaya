        ...
        {!submitted ? (
          <div className="flex flex-col lg:flex-row min-h-[calc(100vh-80px)]">
            ...
            <motion.div
              ...
              className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-700 via-green-600 to-emerald-700 text-white p-12 flex-col justify-center relative overflow-hidden"
            >
              ...
              <div className="absolute inset-0 opacity-20">
                <div 
                  ...
                  style={{
                    backgroundImage: `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="pattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse"><path d="M0,10 Q5,0 10,10 T20,10" fill="none" stroke="white" stroke-width="0.5" opacity="0.5"/><circle cx="10" cy="10" r="2" fill="white" opacity="0.3"/></pattern></defs><rect width="100" height="100" fill="url(%23pattern)"/></svg>')`,
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-100">Simple form, quick confirmation</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="text-white text-xl">✓</div>
                    <div>
                      ...
                      <p className="text-sm text-green-100">9 certified wellness specialists</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="text-white text-xl">✓</div>
                    <div>
                      ...
                      <p className="text-sm text-green-100">In-clinic or tele-consult available</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-12 pt-8 border-t border-green-400/30">
                  <p className="text-sm text-green-50 flex items-start gap-2">
